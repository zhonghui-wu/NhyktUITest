...
class NhyktTest(unittest.TestCase):
    global timelast, courseName, date, auditName, newStudentPhone, newTeacherPhone
    ...
    def tearDownClass(cls):
        ...
        userSQL(
            ...
            sql=f"update user set is_delete = 1 where phone = {newStudentPhone};"
                f""
        )
        print("-----------测试结束！结果发送中。。。-----------")
